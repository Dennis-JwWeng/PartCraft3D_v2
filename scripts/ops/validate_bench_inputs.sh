...
#
# Usage:
#   bash scripts/ops/validate_bench_inputs.sh
#   bash scripts/ops/validate_bench_inputs.sh --all
#   bash scripts/ops/validate_bench_inputs.sh --obj-ids-file configs/shard08_test20_obj_ids.txt
#   INPUT_ROOT=/path/to/bench/inputs bash scripts/ops/validate_bench_inputs.sh --shard 08 --all
...
COMMON=(python scripts/ops/validate_v3_inputs.py --config "$TMP_CFG" --shard "$SHARD")
