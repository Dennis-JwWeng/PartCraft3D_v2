...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 ATTN_BACKEND=xformers \\
        python scripts/data_prep/partverse/prerender.py \\
    ...
    CUDA_VISIBLE_DEVICES=0 ATTN_BACKEND=xformers \\
        python scripts/data_prep/partverse/prerender.py --limit 5
"""
...
from scripts.data_prep.prerender_common import (
...
def _pack_worker(oid: str) -> tuple[str, dict]:
    ...
    from scripts.data_prep.partverse.pack_npz import _pack_one, PACK_VIEWS
    ctx = _pack_ctx
...
def main():
    ...
    _debug_log(
        "H1",
        "scripts/data_prep/partverse/prerender.py:main:pre-load-config",
    ...
    _debug_log(
        "H1",
        "scripts/data_prep/partverse/prerender.py:main:post-load-config",
        "resolved key paths",
        {
    ...
    if args.obj_ids:
        ...
        if args.shard is not None:
            ...
            _debug_log(
                "H2",
                "scripts/data_prep/partverse/prerender.py:main:shard-selection",
    ...
    if args.num_gpus > 1 and do_encode:
        ...
        _debug_log(
            "H3",
            "scripts/data_prep/partverse/prerender.py:main:multi-gpu-entry",
        ...
        if do_render:
            ...
            _debug_log(
                "H4",
                "scripts/data_prep/partverse/prerender.py:main:before-run-render",
            ...
            _debug_log(
                "H4",
                "scripts/data_prep/partverse/prerender.py:main:after-run-render",
        ...
        _debug_log(
            "H5",
            "scripts/data_prep/partverse/prerender.py:main:before-launch-multi-gpu-encode",
        ...
        _debug_log(
            "H5",
            "scripts/data_prep/partverse/prerender.py:main:after-launch-multi-gpu-encode",
