...
Usage:
    ...
    python scripts/data_prep/partverse/pack_npz.py \\
    ...
    python scripts/data_prep/partverse/pack_npz.py --shard 01 --num-shards 10

    # Dry-run: first 5 objects only
    python scripts/data_prep/partverse/pack_npz.py --limit 5

    # Re-pack everything (overwrite)
    python scripts/data_prep/partverse/pack_npz.py --force
"""
