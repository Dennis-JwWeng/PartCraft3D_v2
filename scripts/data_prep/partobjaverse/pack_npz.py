...
Usage:
    python scripts/data_prep/partobjaverse/pack_npz.py --config configs/local_sglang.yaml
    python scripts/data_prep/partobjaverse/pack_npz.py --config configs/local_sglang.yaml --limit 3 --force
"""
