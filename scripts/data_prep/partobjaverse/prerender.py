...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 ATTN_BACKEND=xformers \\
        python scripts/data_prep/partobjaverse/prerender.py \\
...
from scripts.data_prep.prerender_common import launch_multi_gpu_encode, print_summary, run_encode, run_render
