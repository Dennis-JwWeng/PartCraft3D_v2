...
#
#   # Custom model paths
#   VLM_MODEL=/path/to/model bash scripts/serve/launch_local_vlm.sh
#
#   # Use vLLM instead of SGLang
#   BACKEND=vllm bash scripts/serve/launch_local_vlm.sh
#
...
launch_sglang() {
    ...
    # Forward kill signals from the parent (run_pipeline_v3_shard_trellis2.sh
